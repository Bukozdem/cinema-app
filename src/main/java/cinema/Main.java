...
public class Main {
    public static void main(String[] args) {
        ...
        cyborgs.setDescription("Story about russian-Ukrainian war in Donetsk.");
        ...
        try {
            user = authenticationService.register("test@gmail.com", "test");
        } catch (RegistrationException e) {
            throw new RuntimeException("Couldn't register test user in main method", e);
        }
